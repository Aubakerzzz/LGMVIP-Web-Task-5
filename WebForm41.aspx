<%-- ACADEMIC PROFILE HOME --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm41.aspx.cs" Inherits="WebApp01.WebForm41" %>

<!DOCTYPE html>
<html>
  <head>
    <title>Academic Profile Home</title>
...
<body>
  ...
  <div class="center-container">
    <div class="container">
      <h2 class="animated animated-blink">Academic Profile Home</h2>
     ...
     <div class="navbar">
		...
		<ul class="navbar-nav">
			<li><a href="WebForm50.aspx?param1=<%=roll %>" style="background-color: white;">Course Allocation</a></li>
			<li><a href="WebForm50.aspx?param1=<%=roll %>" style="background-color: white;">Create Section</a></li>
            <li><a href="WebForm50.aspx?param1=<%=roll %>" style="background-color: white;">Report Generation</a></li>
