<%-- REPORT GENERATION BY ACADEMIC OFFICE --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm55.aspx.cs" Inherits="WebApp01.WebForm55" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="btnExport" runat="server" Text="OFFERED COURSES EXPORT TO PDF" OnClick="ExportToPDF" CssClass="btn btn-primary btn-primary-blink" />
        </div>
        <div>
            <asp:Button ID="Button1" runat="server" Text="STUDENT SECTION EXPORT TO PDF" OnClick="ExportToPDF1" CssClass="btn btn-primary btn-primary-blink" />
        </div>
        <div>
            <asp:Button ID="Button2" runat="server" Text="COURSE ALLOCATION EXPORT TO PDF" OnClick="ExportToPDF2" CssClass="btn btn-primary btn-primary-blink" />
        </div>
        <div>
