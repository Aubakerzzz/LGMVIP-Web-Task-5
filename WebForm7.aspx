<%-- Faculty SignUp Page --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm7.aspx.cs" Inherits="WebApp01.WebForm7" %>
<!DOCTYPE html>
      ...
      <div class="container">
         ...
         <form id="form1" runat="server">
            ...
            <div class="form-group" style="text-align: right;">
               <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/WebForm6.aspx"  onclick="speak('Welcome back to Faculty Login Form')" >Login</asp:HyperLink>
            </div>
         </form>
      </div>
      <script>
          ...
          function voiceRecognition() {
              ...
              recognition.onresult = function (event) {
                  ...
                  if (input.includes("login")) {
                      speak("Welcome back to Faculty login form");
