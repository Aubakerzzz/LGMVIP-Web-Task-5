<%-- FINALS EVALUATIONS BY TEACHER --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm23.aspx.cs" Inherits="WebApp01.WebForm23" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   ...
   <body>
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <button id="toggle-table1" class="btn btn-primary">FINALS</button>
               <button id="toggle-table2" class="btn btn-primary" style="display:none;">FINAL- I</button>
            </div>
         </div>
         <div class="row">
            <div class="col-md-12">
               <form id="quiz-form" style="display:none;" action="WebForm1.aspx">
                  <table id="usernames-table" class="table table-striped table-bordered font-adjust" style="width: 50%; margin: 0 auto;">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><%= rowCounter1 - 1 %></td>
                           <td><%= col[0] %></td>
                           <td><input type="text" maxlength="1" name="Presence_<%= rowCounter1 - 1 %>" onkeyup="this.value = this.value.replace(/[^PA]/g, '')" /></td>
                        </tr>
                        <% } %>
                        <% rowCounter1++; %>
                        <% } %>
                  ...
                  <div class="submit-container">
                     <input type="hidden" name="param1=" value="<%=roll %>" />
                      ...
                      <input type="hidden" name="param4=" value="Final" />
