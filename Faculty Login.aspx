<%-- Faculty Login --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Faculty Login.aspx.cs" Inherits="WebApp01.WebForm6" %>
      ...
      <div class="container">
         ...
         <form id="form1" runat="server">
            ...
            <div class="form-group" style="text-align: right;">
               <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/WebForm7.aspx" onclick="speak('Welcome to Faculty Signup Page')">SignUp</asp:HyperLink>
            </div>
              ...
              function navigateToPage(page) {
                  switch (page) {
                      case "main":
                          ...
                          break;
                      case "signup":
                          window.location.href = "WebForm7.aspx";
                      default:
                          break;
                  }
              }
              function voiceRecognition() {
                  ...
                  recognition.onresult = function (event) {
                      ...
                      if (input.includes("sign up")) {
                          speak("Welcome to Faculty Signup page");
