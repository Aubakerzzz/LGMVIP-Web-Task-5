<%-- ATTENDANCE FORM BY TEACHER --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm14.aspx.cs" Inherits="WebApp01.WebForm14" %>
<!DOCTYPE html>
   ...
   <body>
            ...
            <div class="col-md-12">
               ...
               <div class="submit-container">
                  ...
                  <%--<button type="submit" class="submit-button" onclick="submit_Click()">Submit</button>--%>
                       <asp:Button runat="server" buttonID="sub" OnClick="submit_Click" CssClass="submit-button" Text="Submit" />
                </form>
               </div>
            </div>
         </div>
         <div class="col-md-12">
            <a href="WebForm15.aspx?param1=<%=Ccode %>&param2=<%=secID %>&param3=<%=roll %>" id="toggle-table2" class="btn btn-primary">Go Back</a>
         </div>
      </div>
      <!-- Bootstrap JS -->
      ...
      <script>
          function voiceRecognition() {
              ...
              const keywords = ["attendance", "back"];
