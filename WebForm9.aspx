<%-- Academic Office SignUp Page --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm9.aspx.cs" Inherits="WebApp01.WebForm9" %>
   ...
   <body>
      <div class="container">
         ...
         <form id="form1" runat="server">
            ...
            <div>
               <asp:Button ID="btnLogin" runat="server" Text="Signup" OnClientClick="return validateForm();" />
            </div>
            <div>
               <span class="error-message" id="error-message" style="display:none;"></span>
            </div>
            <div class="form-group" style="text-align: right;">
               <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/WebForm8.aspx"  onclick="speak('Welcome back to Academic Office Login Form')" >Login</asp:HyperLink>
            </div>
         </form>
      </div>
      <script>
          ...
          function voiceRecognition() {
              ...
              recognition.onresult = function (event) {
                  ...
                  if (input.includes("login")) {
                      speak("Welcome back to Academic Office Login Form");
