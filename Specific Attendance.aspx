<%-- STUDENT ATTENDACE PAGE OF SPECIFIC SUBJECT _____ --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Specific Attendance.aspx.cs" Inherits="WebApp01.WebForm11" %>
   ...
   <body>
      <div class="container">
         ...
         <div class="row">
          ...
          <div class="row">
            <div class="col-md-12">
                <a href="All Attenadance.aspx?param1=<%=roll %>" id="toggle-table7" class="btn btn-primary">Go Back</a>
            </div>
            </div>
         <div class="row">
            <div class="col-md-12">
