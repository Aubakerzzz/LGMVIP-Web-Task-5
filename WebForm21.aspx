<%-- ASSIGNMENTS EVLUATION BY TEACHER --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm21.aspx.cs" Inherits="WebApp01.WebForm21" %>
   ...
   <body>
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               ...
               <button id="toggle-table2" class="btn btn-primary" style="display:none;">Assignment-I</button>
            </div>
         </div>
         <div class="row">
            <div class="col-md-12">
               <form id="quiz-form" style="display:none;" action="WebForm1.aspx">
                  <table id="usernames-table" class="table table-striped table-bordered font-adjust" style="width: 50%; margin: 0 auto;">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><%= rowCounter1 - 1 %></td>
                           <td><%= col[0] %></td>
                           <td><input type="text" maxlength="1" name="Presence_<%= rowCounter1 - 1 %>" /></td>
                        </tr>
                        <% } %>
                        <% rowCounter1++; %>
                        <% } %>
                  ...
                  <div class="submit-container">
                      ...
                      <input type="hidden" name="param4=" value="Assignment" />
         ...
         <div class="row">
            <div class="col-md-12">
               <button id="toggle-table3" class="btn btn-primary" style="display:none;">Assignment-II</button>
            </div>
         </div>
         <div class="row">
            <div class="col-md-12">
               <form id="quiz-form1" style="display:none;" action="WebForm1.aspx">
                  <table id="usernames-table1" class="table table-striped table-bordered font-adjust" style="width: 50%; margin: 0 auto;">
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td><%= rowCounter2 - 1 %></td>
                           <td><%= col[0] %></td>
                           <td><input type="text" maxlength="1" name="Presence_<%= rowCounter2 - 1 %>"  /></td>
                        </tr>
                        <% } %>
                        <% rowCounter2++; %>
                        <% } %>
                  ...
                  <div class="submit-container">
                      ...
                      <input type="hidden" name="param3=" value="<%=secID %>" />
                      <input type="hidden" name="param4=" value="Assignment" />
                      <input type="hidden" name="param5=" value="2" />
                      <input type="hidden" name="param6=" value="<%=Data[0][2] %>" />
         ...
         <div class="row">
            <div class="col-md-12">
               <button id="toggle-table4" class="btn btn-primary" style="display:none;">Assignment-III</button>
            </div>
         </div>
         <div class="row">
            <div class="col-md-12">
               <form id="quiz-form2" style="display:none;" action="WebForm1.aspx">
                  <table id="usernames-table2" class="table table-striped table-bordered font-adjust" style="width: 50%; margin: 0 auto;">
                     <thead>
                        <tr>
                           <th>Student No</th>
                           <th>Name</th>
                           <th>Assignment-III Marks</th>
                        </tr>
                     </thead>
                     <tbody>
                        <% int rowCounter3 = 1; %>
                        ...
                        <tr>
                           <td><%= rowCounter2 - 1 %></td>
                           <td><%= col[0] %></td>
                           <td><input type="text" maxlength="1" name="Presence_<%= rowCounter3 - 1 %>" /></td>
                        </tr>
                        <% } %>
                        <% rowCounter3++; %>
                        <% } %>
                  ...
                  <div class="submit-container">
                      ...
                      <input type="hidden" name="param3=" value="<%=secID %>" />
                      <input type="hidden" name="param4=" value="Assignment" />
                      <input type="hidden" name="param5=" value="3" />
                      <input type="hidden" name="param6=" value="<%=Data[0][2] %>" />
      ...
      <script>
         $(document).ready(function () {
             ...
             $("#toggle-table4").click(function () {
                 if ($("#quiz-form2").is(":visible")) {
                     $("#usernames-table2").hide();
                     $("#quiz-form2").hide();
                 } else {
                     $("#usernames-table2").show();
                     $("#quiz-form2").show();
                 }
             });
      ...
      <script>
          function voiceRecognition() {
              ...
              const keywords = ["assignments", "back"];
