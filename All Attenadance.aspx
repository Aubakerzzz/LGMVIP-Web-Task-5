<%-- Course Options For Attendance Of Students --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="All Attenadance.aspx.cs" Inherits="WebApp01.WebForm12" %>
   ...
   <body>
      <div class="container">
         <% int rowCounter1 = 0; %>
          ...
          <div class="row">
            <div class="col-md-12">
                <a href="Specific Attendance.aspx?param1=<%=roll %>&param2=<%=Data[rowCounter1]%>" id="toggle-table<%=rowCounter1 + 1 %>" class="btn btn-primary"> <%=Data[rowCounter1] %></a>        
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-md-12">
                <a href="WebForm18.aspx" id="toggle-table6" class="btn btn-primary">Go Back</a>
            </div>
         </div>
      </div>
      ...
      <script>
          function navigateToPage(page) {
              switch (page) {
                  case "database":
                      window.location.href = "WebForm11.aspx";
                      break;
                  case "operating":
		...
		<ul class="navbar-nav">
			...
			<li><a href="WebForm18.aspx?param1=<%=roll %>" style="background-color: white;">CGPAs GRAPH</a></li>
