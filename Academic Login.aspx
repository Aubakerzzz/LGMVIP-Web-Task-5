<%-- Academic Office Login Page --%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Academic Login.aspx.cs" Inherits="WebApp01.WebForm8" %>
      ...
      <div class="container">
         ...
         <form id="form1" runat="server">
            ...
            <div class="form-group" style="text-align: right;">
               <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/WebForm9.aspx" onclick="speak('Welcome to Academic Office Signup Page')">SignUp</asp:HyperLink>
            </div>
              ...
              function navigateToPage(page) {
                  switch (page) {
                      case "main":
                          ...
                          break;
                      case "signup":
                          window.location.href = "WebForm9.aspx";
                      default:
                          break;
                  }
              }
              function voiceRecognition() {
                  ...
                  recognition.onresult = function (event) {
                      ...
                      if (input.includes("sign up")) {
                          speak("Welcome to Academic Office Signup page");
