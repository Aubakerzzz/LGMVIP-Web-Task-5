<%-- Evaluation Page OF Students Quiz/ASSIGNMENTS/SESSIONALS/FINALS :)--%>
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Specific Marks.aspx.cs" Inherits="WebApp01.WebForm24" %>
         ...
         <div class="row">
            <div class="col-md-12">
               <table id="usernames-table2" class="table table-striped table-bordered font-adjust" style="display: none;">
                  ...
                  <tbody>
                     <% int rowCounter3 = 1; disp = 1; %>
                     <% foreach (string[] col in Data) { %>
                     <% if (rowCounter3 > 1) { %>
                     <tr>
                        <% if (col[2] == "Sessional-1" || col[2] == "Sessional-2") { %>
                        <td><%= disp %></td>
                        <td><%= col[0] %></td>
                        <td><%= col[1] %></td>
                          <% disp++; %>
